...
<div class="wp-block-group pegasus-promo__issue"><!-- wp:image {"sizeSlug":"large","linkDestination":"custom","className":"pegasus-promo__cover"} -->
...
<div class="wp-block-group pegasus-promo__featured"><!-- wp:paragraph {"className":"pegasus-promo__eyebrow u-uppercase u-tracking-wide","textColor":"muted","fontSize":"small"} -->
